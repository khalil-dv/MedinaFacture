...
const fr: Record<string, string> = {
  ...
  "landing.how.subtitle": "Trois étapes simples pour facturer comme un pro.",
  "landing.how.s1.title": "Inscris-toi",
  "landing.how.s1.desc": "Crée ton compte gratuit en 30 secondes. Aucune carte bancaire requise.",
  "landing.how.s2.title": "Crée ta facture",
  "landing.how.s2.desc": "Ajoute tes clients, tes services et laisse la TVA se calculer automatiquement.",
  "landing.how.s3.title": "Envoie et encaisse",
  "landing.how.s3.desc": "Envoie ta facture par email et suis les paiements en temps réel.",
  "landing.testimonials.title": "Ils nous font confiance",
  "landing.testimonials.subtitle": "Des entrepreneurs à travers l'Afrique qui facturent avec MedinaFacture.",
  "landing.testimonials.t1.name": "Aminata Diallo",
  "landing.testimonials.t1.role": "Fondatrice, Studio Créatif Dakar",
  "landing.testimonials.t1.text": "Avant MedinaFacture, je passais des heures sur Excel. Maintenant, je crée mes factures en 2 minutes et je suis tout sur mon téléphone.",
  "landing.testimonials.t2.name": "Koffi Mensah",
  "landing.testimonials.t2.role": "DG, Tech Solutions Abidjan",
  "landing.testimonials.t2.text": "La TVA automatique m'a fait gagner un temps fou. Fini les erreurs de calcul, mes clients sont plus satisfaits.",
  "landing.testimonials.t3.name": "Carine Ngo Biyick",
  "landing.testimonials.t3.role": "CEO, FitPlus Yaoundé",
  "landing.testimonials.t3.text": "Le suivi des paiements en temps réel a transformé ma gestion. Je sais exactement qui a payé et qui doit encore.",
  "landing.pricing.title": "Des tarifs adaptés à vous",
  "landing.pricing.subtitle": "Commence gratuitement, évolue quand tu es prêt.",
  "landing.pricing.free": "Gratuit",
  "landing.pricing.freeDesc": "Pour démarrer",
  "landing.pricing.freePrice": "0 FCFA",
  "landing.pricing.freePeriod": "/mois",
  "landing.pricing.freeF1": "5 factures / mois",
  "landing.pricing.freeF2": "1 utilisateur",
  "landing.pricing.freeF3": "Clients illimités",
  "landing.pricing.freeF4": "TVA automatique",
  "landing.pricing.freeF5": "Export PDF",
  "landing.pricing.freeCta": "Commencer gratuitement",
  "landing.pricing.pro": "Pro",
  "landing.pricing.proDesc": "Pour les pros",
  "landing.pricing.proPrice": "5 000 FCFA",
  "landing.pricing.proPeriod": "/mois",
  "landing.pricing.proF1": "Factures illimitées",
  "landing.pricing.proF2": "3 utilisateurs",
  "landing.pricing.proF3": "Rappels automatiques",
  "landing.pricing.proF4": "Suivi avancé",
  "landing.pricing.proF5": "Support prioritaire",
  "landing.pricing.proCta": "Commencer maintenant",
  "landing.pricing.business": "Business",
  "landing.pricing.businessDesc": "Pour les équipes",
  "landing.pricing.businessPrice": "15 000 FCFA",
  "landing.pricing.businessPeriod": "/mois",
  "landing.pricing.businessF1": "Tout du plan Pro",
  "landing.pricing.businessF2": "Utilisateurs illimités",
  "landing.pricing.businessF3": "Multi-sociétés",
  "landing.pricing.businessF4": "API intégration",
  "landing.pricing.businessF5": "Support dédié",
  "landing.pricing.businessCta": "Contacter l'équipe",
  "landing.pricing.popular": "Le plus populaire",
  "landing.pricing.noCard": "Aucune carte bancaire requise",
...
const en: Record<string, string> = {
  ...
  "landing.how.subtitle": "Three simple steps to invoice like a pro.",
  "landing.how.s1.title": "Sign up",
  "landing.how.s1.desc": "Create your free account in 30 seconds. No credit card required.",
  "landing.how.s2.title": "Create your invoice",
  "landing.how.s2.desc": "Add your clients, your services and let VAT calculate automatically.",
  "landing.how.s3.title": "Send & collect",
  "landing.how.s3.desc": "Send your invoice by email and track payments in real time.",
  "landing.testimonials.title": "Trusted by entrepreneurs",
  "landing.testimonials.subtitle": "African entrepreneurs across the continent who invoice with MedinaFacture.",
  "landing.testimonials.t1.name": "Aminata Diallo",
  "landing.testimonials.t1.role": "Founder, Studio Créatif Dakar",
  "landing.testimonials.t1.text": "Before MedinaFacture, I spent hours on Excel. Now I create my invoices in 2 minutes and track everything on my phone.",
  "landing.testimonials.t2.name": "Koffi Mensah",
  "landing.testimonials.t2.role": "CEO, Tech Solutions Abidjan",
  "landing.testimonials.t2.text": "Automatic VAT saved me so much time. No more calculation errors, my clients are happier.",
  "landing.testimonials.t3.name": "Carine Ngo Biyick",
  "landing.testimonials.t3.role": "CEO, FitPlus Yaoundé",
  "landing.testimonials.t3.text": "Real-time payment tracking transformed my management. I know exactly who paid and who still owes.",
  "landing.pricing.title": "Plans that fit you",
  "landing.pricing.subtitle": "Start free, upgrade when you're ready.",
  "landing.pricing.free": "Free",
  "landing.pricing.freeDesc": "To get started",
  "landing.pricing.freePrice": "0 FCFA",
  "landing.pricing.freePeriod": "/month",
  "landing.pricing.freeF1": "5 invoices / month",
  "landing.pricing.freeF2": "1 user",
  "landing.pricing.freeF3": "Unlimited clients",
  "landing.pricing.freeF4": "Auto VAT",
  "landing.pricing.freeF5": "PDF export",
  "landing.pricing.freeCta": "Get started free",
  "landing.pricing.pro": "Pro",
  "landing.pricing.proDesc": "For pros",
  "landing.pricing.proPrice": "5,000 FCFA",
  "landing.pricing.proPeriod": "/month",
  "landing.pricing.proF1": "Unlimited invoices",
  "landing.pricing.proF2": "3 users",
  "landing.pricing.proF3": "Auto reminders",
  "landing.pricing.proF4": "Advanced tracking",
  "landing.pricing.proF5": "Priority support",
  "landing.pricing.proCta": "Start now",
  "landing.pricing.business": "Business",
  "landing.pricing.businessDesc": "For teams",
  "landing.pricing.businessPrice": "15,000 FCFA",
  "landing.pricing.businessPeriod": "/month",
  "landing.pricing.businessF1": "Everything in Pro",
  "landing.pricing.businessF2": "Unlimited users",
  "landing.pricing.businessF3": "Multi-company",
  "landing.pricing.businessF4": "API integration",
  "landing.pricing.businessF5": "Dedicated support",
  "landing.pricing.businessCta": "Contact team",
  "landing.pricing.popular": "Most popular",
  "landing.pricing.noCard": "No credit card required",
