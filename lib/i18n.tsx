...
const fr: Record<string, string> = {
  ...
  "signup.firstNamePlaceholder": "Amadou",
  "signup.lastName": "Nom",
  "signup.lastNamePlaceholder": "Bâ",
  "signup.company": "Entreprise",
  "signup.companyPlaceholder": "Nom de votre société",
  "signup.email": "Email",
  ...
  "landing.nav.start": "Commencer gratuitement",
  "landing.hero.title1": "Fini les factures sur",
  "landing.hero.titleHighlight": "Word et Excel.",
  "landing.hero.subtitle": "Le SaaS de facturation simple et moderne conçu pour les entrepreneurs africains.",
  "landing.hero.start": "Commencer gratuitement",
  "landing.hero.demo": "Voir la démo",
  "landing.hero.badge": "Gratuit · Sans carte bancaire",
  "landing.problem.title": "Pourquoi changer vos habitudes ?",
  "landing.problem.subtitle": "Les méthodes traditionnelles vous font perdre du temps et de l'argent.",
  "landing.problem.p1.title": "Factures non professionnelles",
  "landing.problem.p1.desc": "Des documents mal formatés qui renvoient une image amateur à vos clients.",
  "landing.problem.p2.title": "Calculs manuels",
  "landing.problem.p2.desc": "Des erreurs de calcul et de TVA qui compliquent votre comptabilité.",
  "landing.problem.p3.title": "Suivi impossible",
  "landing.problem.p3.desc": "Incapacité de savoir quelles factures sont payées, en attente ou en retard.",
  "landing.features.title": "Tout ce dont vous avez besoin",
  "landing.features.subtitle": "Une suite d'outils puissants dans une interface épurée.",
  "landing.features.f1.title": "Facturation rapide",
  "landing.features.f1.desc": "Créez et envoyez des factures professionnelles en moins de 60 secondes avec nos modèles prêts à l'emploi.",
  "landing.features.f2.title": "TVA automatique",
  "landing.features.f2.desc": "Calcul automatique des taxes et totaux. Fini les erreurs de saisie sur vos factures importantes.",
  "landing.features.f3.title": "Suivi en temps réel",
  "landing.features.f3.desc": "Tableau de bord intelligent pour suivre vos revenus, les paiements en attente et relancer d'un clic.",
  "landing.features.f4.title": "Gestion clients",
  "landing.features.f4.desc": "Annuaire intégré pour enregistrer vos clients récurrents et générer leurs factures encore plus vite.",
  "landing.cta.title": "Rejoins les entrepreneurs qui facturent comme des pros.",
  "landing.cta.start": "Commencer gratuitement",
  "landing.footer.tagline": "Fait avec fierté en Afrique.",
  ...
  "landing.footer.help": "Aide et contact",
...
const en: Record<string, string> = {
  ...
  "signup.companyPlaceholder": "Your company name",
  "signup.email": "Email",
  ...
  "landing.nav.start": "Get started free",
  "landing.hero.title1": "Ditch the",
  "landing.hero.titleHighlight": "Word & Excel invoices.",
  "landing.hero.subtitle": "The simple, modern invoicing SaaS built for African entrepreneurs.",
  "landing.hero.start": "Get started free",
  "landing.hero.demo": "See the demo",
  "landing.hero.badge": "Free · No credit card",
  "landing.problem.title": "Why change your habits?",
  "landing.problem.subtitle": "Traditional methods cost you time and money.",
  "landing.problem.p1.title": "Unprofessional invoices",
  "landing.problem.p1.desc": "Poorly formatted documents that give clients an amateur impression.",
  "landing.problem.p2.title": "Manual calculations",
  "landing.problem.p2.desc": "VAT and total errors that complicate your accounting.",
  "landing.problem.p3.title": "Impossible tracking",
  "landing.problem.p3.desc": "No way to know which invoices are paid, pending, or overdue.",
  "landing.features.title": "Everything you need",
  "landing.features.subtitle": "A powerful suite of tools in a clean interface.",
  "landing.features.f1.title": "Fast invoicing",
  "landing.features.f1.desc": "Create and send professional invoices in under 60 seconds with ready-to-use templates.",
  "landing.features.f2.title": "Auto VAT",
  "landing.features.f2.desc": "Automatic tax and total calculations. No more input errors on your important invoices.",
  "landing.features.f3.title": "Real-time tracking",
  "landing.features.f3.desc": "Smart dashboard to track revenue, pending payments, and follow up with one click.",
  "landing.features.f4.title": "Client management",
  "landing.features.f4.desc": "Built-in directory to store recurring clients and generate their invoices even faster.",
  "landing.cta.title": "Join the entrepreneurs invoicing like pros.",
  "landing.cta.start": "Get started free",
  "landing.footer.tagline": "Proudly built in Africa.",
